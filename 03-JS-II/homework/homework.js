...
function esEntero(numero) {
    ...
    // Tu código:
    let a = Math.floor(numero);
    if (numero === a) { return true; } else { return false; }
}
...
function fizzBuzz(numero) {
    ...
    if (numero % 3 === 0 && numero % 5 === 0 && numero !== 0) { return "fizzbuzz"; }
    if (numero % 3 === 0 && numero !== 0) { return "fizz"; }
    if (numero % 5 === 0 && numero !== 0) { return "buzz"; }
    return numero;
}
